...
<div class="form-group">
    ...
    <input type="text" name="title" class="form-control" value="{{ old('title', $new->title) }}" id="exampleInputEmail1"
...
<div class="form-group my-3">
    ...
    <div class="mt-1" id="imagePreview">
        ...
        @if ($new->image)
            <img style="object-fit: cover" src="{{ asset("storage/$new->image") }}" width="60" height="60"
                alt="img">
        @endif
    </div>
