        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4">
                <div class="float-end d-none d-md-block">
                    <div class="dropdown">
                        <a class="btn btn-primary" href="{{ route('posts.create') }}" type="button">
                            <i class="mdi mdi-plus me-2"></i> اضافة مقالة
                        </a>
                    </div>
                </div>
            </div>
                                            ...
                                            @foreach ($posts as $post)
                                                <tr>
                                                    ...
                                                    <td class="align-middle"><img
                                                            ...
                                                            src="{{ asset("storage/$post->image") }}" width="60"
                                                    ...
                                                    <td class="align-middle">
                                                        ...
                                                        <form action="{{ route('posts.destroy', $post->id) }}"
                                                            method="POST" id="deleteForm{{ $post->id }}">
                                                            @csrf
                                                            @method('DELETE')
